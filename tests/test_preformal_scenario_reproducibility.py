...
def test_same_seed_reproducible_different_seed_changes():
    r=verify_scenario_reproducibility({'dynamic':{'demand':1}}, {'dynamic_seed':7,'realization_seed':8}, {'dynamic_seed':9,'realization_seed':8})
    assert r['same_seed']['scenario_content_hash'] != r['changed_seed_scenario_content_hash']
