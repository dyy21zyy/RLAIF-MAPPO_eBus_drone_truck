...
### Phase 5 bus loading and flash charging

Phase 5 separates bus control into terminal loading-batch decisions and station
flash-charging-duration decisions. Freight batches are generated by deterministic
heuristics and masked by hard 20 kg onboard / 10 kg per-station unloading limits.
Charging candidates use 0–120 second actions, two chargers per station,
overcharge masking, and passenger-aware delay propagation on physical buses.
