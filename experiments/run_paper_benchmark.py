    ...
    for sc in bank.scenarios:
        ...
        for m in cfg.get('methods',[]):
            ...
            for seed in seeds:
                ...
                row.update({'reward_scale_artifact_path':m.get('reward_scale_artifact_path',cfg.get('reward_scale_artifact_path')),'reward_scale_artifact_hash':m.get('reward_scale_artifact_hash',cfg.get('reward_scale_artifact_hash'))})
                try:
                    import dataclasses
