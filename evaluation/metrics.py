...
def collect_environment_metrics(env, *, bus_charging_count=0, bus_charging_energy=0.0, fallback_events=0):
    ...
    return {
        ...
        "battery_shortage_count": raw_cost("battery_shortage"), "locker_overflow_amount": raw_cost("locker_overflow"),
        "locker_overflow_duration": 0.0, "power_overload_amount": raw_cost("power_overload"),
        "power_overload_duration": 0.0, "peak_station_load": float(getattr(env, "peak_station_load_kw", 0.0)),
