...
def generate_formal_launch_plan(resolved:dict, output_path:str|Path)->dict:
    ...
    train_cfg={'assignment_ppo':'configs/paper/train_assignment_ppo.yaml','mappo_env':'configs/paper/train_mappo_env.yaml','mappo_rlaif_assignment':'configs/paper/train_mappo_rlaif_assignment.yaml','mappo_rlaif_all':'configs/paper/train_mappo_rlaif_all.yaml'}
    ...
    add('final_benchmark', _cmd(['python','-m','experiments.run_paper_benchmark','--config','results/formal/configs/benchmark.resolved.yaml','--output-root','results/formal/benchmark']), config_path='results/formal/configs/benchmark.resolved.yaml', output_dir='results/formal/benchmark', expected_input_hash=hashes.get('benchmark_config_hash'))
